        ...
        <div class="account-wrap">
                ...
                <template v-if="!reset">
                    ...
                    <div class="login-button-wrap">
                        <div class="reset" @click="reset = true">
                            <i class="mdi mdi-lock-reset" />忘記密碼
                        </div>
                        <div class="login" @click="submitLogin">
                            <i class="mdi mdi-account" />登入
                        </div>
                    </div>
                </template>
                <template v-else>
                    <!-- reset -->
                    <write-form
                        v-model:info="resetPasswordForm"
                        current-tab="reset"
                    />
                    <div class="reset-button-wrap">
                        <div class="reset" @click="submitForget">
                            <i class="mdi mdi-cached" />重設密碼
                        </div>
                        <div class="login" @click="reset = false">
                            <i
            ...
            <div class="form" v-if="!currentTab">
                ...
                <div class="sign" @click="submitSign">
                    <i class="mdi mdi-account-plus" />註冊
                </div>
            </div>
        </div>
 ...
 */
const fieldEmpty = (
    formData: LoginForm | SignForm | ResetPasswordForm,
): boolean => {
